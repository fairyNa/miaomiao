<template>
        ...
        <Header title="影片详情">
            ...
            <i  class="iconfont icon-right" @touchstart="handleToBack"></i><h1></h1>
        </Header>
...
<style scoped>
#detailContrainer{width: 100%; position: absolute;top: 0;left: 0;min-height: 100%;background: white; z-index: 100;}
